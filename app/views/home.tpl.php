  ...
  <section>
    <div class="container-fluid">
      <div class="row mx-0">
        ...
        <div class="col-md-6">
          <div class="card border-0 text-white text-center"><img src="<?=$assetsFolder?>/images/categ2.jpeg"
              alt="Card image" class="card-img">
            <div class="card-img-overlay d-flex align-items-center">
              <div class="w-100 py-3">
      ...
      <div class="row mx-0">
        ...
        <div class="col-lg-4">
          <div class="card border-0 text-center text-white"><img src="<?=$assetsFolder?>/images/categ4.jpeg"
              alt="Card image" class="card-img">
            <div class="card-img-overlay d-flex align-items-center">
              <div class="w-100">
        ...
        <div class="col-lg-4">
            <div class="card border-0 text-center text-dark">
              <img src="<?=$assetsFolder?>/images/categ1.jpeg"
                alt="Card image" class="card-img">
              <div class="card-img-overlay d-flex align-items-center">
                <div class="w-100">
